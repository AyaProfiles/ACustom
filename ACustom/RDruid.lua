...
local Q=er.AoEON;local pVRj=er.CDsON;local pVRj=ZG.Druid.Restoration;local qkP7O5=UnitExists
local lqT=GetNumGroupMembers;local mP3mlD=UnitGetIncomingHeals;local PrPyxMK=UnitHealthMax;local tczrIB=UnitIsDead
local a=UnitHealth;local wqU76o=GetUnitName;local LB1Z=UnitGUID;local N9L=table;local hDc_M=GetTime;local qW0lRiD1=tonumber
local iD1IUx=string;local JLCOx_ak=UnitBuff;local hPQ=select;local R1FIoQI=type;local NsoTwDs=GetTotemInfo;local HGli=floor
...
dijn4Ph=fuZ3z86.Config.GetSetting('Aya_Rdruid_Config',"ManaManagement")Ib4=Ib4
...
local function nSBOx7(QKKks_zt,fuZ3z86)local Vu0cCAf,pVRj
if not fuZ3z86 then if wqU76o("player",true)==QKKks_zt then
return LB1Z("player")end;if wqU76o("target",true)==QKKks_zt then return
WYdR("target"):GUID()end;if
wqU76o("focus",true)==QKKks_zt then return LB1Z("focus")end;pVRj=lqT()if pVRj>0 and
pVRj<=5 then
for pVRj=1,pVRj do if wqU76o("party"..pVRj,true)==QKKks_zt then return
LB1Z("party"..pVRj)end end end;if pVRj>5 then
for pVRj=1,pVRj do if wqU76o(
"raid"..pVRj,true)==QKKks_zt then
return LB1Z("raid"..pVRj)end end end else if
wqU76o("player",true)==QKKks_zt then return"player"end;if
wqU76o("target",true)==QKKks_zt then return"target"end;if
wqU76o("focus",true)==QKKks_zt then return"focus"end;pVRj=lqT()if pVRj>0 and
pVRj<=5 then
for pVRj=1,pVRj do if wqU76o("party"..pVRj,true)==QKKks_zt then return
...
local function LB1Z()if missedunit then
N9L.insert(Hv,(nSBOx7(missedunit).." "..hDc_M()))missedunit=nil end
if
N9L.getn(Hv)>0 then
for QKKks_zt=1,N9L.getn(Hv)do
if Hv[QKKks_zt]~=nil then
for pVRj in
iD1IUx.gmatch(Hv[QKKks_zt],"([^%s]+)")do pVRj=qW0lRiD1(pVRj)
if R1FIoQI(pVRj)=="number"then if
pVRj<=hDc_M()-1.5 then N9L.remove(Hv,QKKks_zt)end end end end end end end
local function wqU76o(pVRj)
if N9L.getn(Hv)>0 and pVRj~=nil then
for QKKks_zt=1,N9L.getn(Hv)do for QKKks_zt in
iD1IUx.gmatch(Hv[QKKks_zt],"([^%s]+)")do
...
hPQ(10,JLCOx_ak(pVRj,QKKks_zt))==365153 then
return hPQ(16,JLCOx_ak(pVRj,QKKks_zt))end end else return 0 end end
local function N9L(fuZ3z86)
if fuZ3z86 ==nil or R1FIoQI(fuZ3z86)=="string"then return nil end;fuZ3z86=fuZ3z86/100;local pVRj=0
if lqT()>0 and lqT()<=5 then
for QKKks_zt=1,lqT()do
if
qkP7O5("party"..QKKks_zt)and
not WYdR("party"..QKKks_zt):IsDeadOrGhost()and
WYdR("party"..QKKks_zt):DebuffDown(ZG(228578))then
local Vu0cCAf=

a("party"..QKKks_zt)+ (mP3mlD("party"..QKKks_zt)or 0)-Hv("party"..QKKks_zt)local QKKks_zt=PrPyxMK("party"..QKKks_zt)if
Vu0cCAf/QKKks_zt<=fuZ3z86 then pVRj=pVRj+1 end end end;if((
(a("player")+ (mP3mlD("player")or 0))/PrPyxMK("player"))<
fuZ3z86)then
pVRj=pVRj+1 end end
if lqT()>5 then
for QKKks_zt=1,lqT()do
...
qkP7O5("raid"..QKKks_zt)and
not tczrIB("raid"..QKKks_zt)and
WYdR("raid"..QKKks_zt):DebuffDown(ZG(362075))and
WYdR("raid"..QKKks_zt):DebuffDown(ZG(362397))and
WYdR("raid"..QKKks_zt):DebuffDown(ZG(191587))then local Vu0cCAf=0
local Vu0cCAf=a("raid"..QKKks_zt)+
(mP3mlD("raid"..QKKks_zt)or 0)-Hv("raid"..QKKks_zt)local QKKks_zt=PrPyxMK("raid"..QKKks_zt)if
Vu0cCAf/QKKks_zt<=fuZ3z86 then pVRj=pVRj+1 end end end end
if lqT()==0 then local Vu0cCAf=a("player")+ (mP3mlD("player")or 0)-
Hv("player")
local QKKks_zt=PrPyxMK("player")if Vu0cCAf/QKKks_zt<=fuZ3z86 then pVRj=pVRj+1 end end;return pVRj end
local function PrPyxMK()
for QKKks_zt=1,4 do local Are7xU,Vu0cCAf,QKKks_zt,fuZ3z86=NsoTwDs(QKKks_zt)
if Vu0cCAf==
pVRj.Efflorescence:Name()then return
(HGli(QKKks_zt+fuZ3z86-hDc_M()+.5))or 0 end end;return 0 end
local function ZG()
if

pVRj.ConvoketheSpirits:IsReady()and Are7xU:IsInMeleeRange(40)and zz1QI=="ConvokeDamage"and
(
qkP7O5("boss1")or XL_.FightRemains(urkh)>30)and
...
if NUhYw6R4 <3 and Ib4 and NUhYw6R4 >0 and kFTAh then
if
pVRj.CatForm:IsReady(QKKks_zt)and QKKks_zt:BuffDown(pVRj.CatForm)then if
Vu0cCAf(pVRj.CatForm)then return'Cat Form for Convoke'end end elseif NUhYw6R4 >=3 and Ib4 and kFTAh then
if
pVRj.BearForm:IsReady(QKKks_zt)and QKKks_zt:BuffDown(pVRj.BearForm)then if
Vu0cCAf(pVRj.BearForm)then return'BearForm for Convoke'end end end
...
if
pVRj.NaturesVigil:IsReady()and(qkP7O5("boss1")or
...
local function a()local Ib4,kFTAh,Hv,kFTAh,kFTAh,kFTAh=DFb100j:Update()Do()
if Q()then
m6SCS0=QKKks_zt:GetEnemiesInRangeFilter(10)urkh=WYdR:GetEnemiesInSplashRange(10)NUhYw6R4=#m6SCS0
Ch=WYdR:GetEnemiesInSplashRangeCount(10)else NUhYw6R4=1;Ch=1 end;local kFTAh=XL_.CombatTime()
local NUhYw6R4=
...
if kFTAh==0 and pVRj.Revive:IsReady(QKKks_zt)then if
...
if
pVRj.Innervate:IsReady()and QKKks_zt:AffectingCombat()and not NUhYw6R4 then
if CO1 =="InnervatePlayer"then
if
fuZ3z86.CastCycleAlly(pVRj.Innervate,Hv,function(pVRj)return

pVRj:GUID()==QKKks_zt:GUID()and
pVRj:ManaPercentage()<=InnervateMana and not wqU76o(pVRj)end)then return'Innervate Player'end end
...
pVRj:ManaPercentage()<=InnervateMana and not wqU76o(pVRj)end)then return'Innervate Target'end end
...
pVRj:ManaPercentage()<=InnervateMana and not wqU76o(pVRj)end)then return'Innervate MouseOver'end end end
if pVRj.AdaptiveSwarm:IsCastable()and not NUhYw6R4 and
QKKks_zt:BuffDown(pVRj.Prowl)then
if
fuZ3z86.CastCycleAlly(pVRj.AdaptiveSwarm,Hv,function(QKKks_zt)return

QKKks_zt:BuffStack(pVRj.AdaptiveSwarmBuff)==2 and not wqU76o(QKKks_zt)end)then return'Adaptive Swarm Members 2 Stacks'end
if
fuZ3z86.CastCycleAlly(pVRj.AdaptiveSwarm,Hv,function(QKKks_zt)
return
QKKks_zt:BuffStack(pVRj.AdaptiveSwarmBuff)==1 and not wqU76o(QKKks_zt)end)then return'Adaptive Swarm Members 1 Stacks'end
if
fuZ3z86.CastCycleAlly(pVRj.AdaptiveSwarm,Hv,function(QKKks_zt)
return
QKKks_zt:BuffStack(pVRj.AdaptiveSwarmBuff)==3 and not wqU76o(QKKks_zt)end)then return'Adaptive Swarm Members 3 Stacks'end
if
fuZ3z86.CastCycleAlly(pVRj.AdaptiveSwarm,Hv,function(QKKks_zt)
return
QKKks_zt:BuffStack(pVRj.AdaptiveSwarmBuff)==0 and not wqU76o(QKKks_zt)end)then return'Adaptive Swarm Members 0 Stacks'end end
if NUhYw6R4 then
if pVRj.Ironbark:IsCastable()then
if
fuZ3z86.CastCycleAlly(pVRj.Ironbark,Hv,function(pVRj)
return
pVRj:HealthPercentage()<seMLr and not wqU76o(pVRj)end)then return'Ironbark Members'end end
if
...
return
pVRj:HealthPercentage()<zhzpBSx and not wqU76o(pVRj)end)then return'Convoke the Spirits - Heal'end end
if
...
wqU76o(pVRj)end)then return'Wild Growth before Flourish'end end
if
...
if
fuZ3z86.CastCycleAlly(pVRj.WildGrowth,Hv,function(pVRj)return pVRj:HealthPercentage()<zhzpBSx and not
wqU76o(pVRj)end)then return'Wild Growth before Tranquility'end end
if
...
(
(QKKks_zt:BuffDown(pVRj.Rejuvenation))and not wqU76o(QKKks_zt))end)then return'Rejuvenation Spread Members - toggle'end end
if lqT()<=5 then
if
...
if
fuZ3z86.CastCycleAlly(pVRj.LifebloomResto,Hv,function(QKKks_zt)
return QKKks_zt:BuffDown(pVRj.LifebloomResto)and
QKKks_zt:HealthPercentage()<80 and
not wqU76o(QKKks_zt)end)then return'Lifebloom Members'end
if
...
wqU76o(fuZ3z86)end)then return'Lifebloom Player'end end end
if
...
QKKks_zt:BuffDown(pVRj.CatForm)and QKKks_zt:BuffDown(pVRj.BearForm)and QKKks_zt:BuffDown(pVRj.TravelForm)and QKKks_zt:BuffDown(iy)))then
if
fuZ3z86.CastCycleAlly(pVRj.LifebloomResto,Ib4,function(QKKks_zt)
return QKKks_zt:BuffDown(pVRj.LifebloomResto)and not
wqU76o(QKKks_zt)end)then return'Lifebloom Tanks'end end
if
...
QKKks_zt:BuffDown(pVRj.CatForm)and QKKks_zt:BuffDown(pVRj.BearForm)and QKKks_zt:BuffDown(pVRj.TravelForm)and QKKks_zt:BuffDown(iy)))then
if
fuZ3z86.CastCycleAlly(pVRj.LifebloomResto2,Ib4,function(QKKks_zt)
return QKKks_zt:BuffDown(pVRj.LifebloomResto2)and not
wqU76o(QKKks_zt)end)then return'Lifebloom Tanks - No S.Undergrowth'end end
if
...
QKKks_zt:AffectingCombat())and not QKKks_zt:IsMoving()and PrPyxMK()<2 and N9L(w8T3f)>=K and not NUhYw6R4 and
((QKKks_zt:BuffDown(pVRj.CatForm)and QKKks_zt:BuffDown(pVRj.BearForm)))then
if Vu0cCAf(pVRj.Efflorescence)then return"Efflorescence Members"end end
if QKKks_zt:AffectingCombat()and N9L(Ki1)==0 and
...
wqU76o(QKKks_zt)end)then return'Swiftmend Members'end
if

(N9L(h_8)>=xL7OTb or QKKks_zt:BuffUp(pVRj.IncarnationTreeofLifeBuff))and QKKks_zt:BuffDown(pVRj.SouloftheForestBuff)then
if
fuZ3z86.CastCycleAlly(pVRj.Swiftmend,Hv,function(QKKks_zt)return

(QKKks_zt:BuffUp(pVRj.Regrowth)or
QKKks_zt:BuffUp(pVRj.WildGrowth)or QKKks_zt:BuffUp(pVRj.Rejuvenation))and not wqU76o(QKKks_zt)end)then return'Swiftmend Before WildGrowth'end end
if



pVRj.Rejuvenation:IsCastable()and(N9L(h_8)>=xL7OTb or
...
if
fuZ3z86.CastCycleAlly(pVRj.Rejuvenation,Hv,function(pVRj)return not wqU76o(pVRj)end)then return'Rejuv Members for Swiftmend into WildGrowth'end end end
if
...
(
N9L(h_8)>=xL7OTb or QKKks_zt:BuffUp(pVRj.IncarnationTreeofLifeBuff))then
if Vu0cCAf(pVRj.WildGrowth)then return'Wild Growth Members'end end
if pVRj.CenarionWard:IsReady()then
if
fuZ3z86.CastCycleAlly(pVRj.CenarionWard,Ib4,function(QKKks_zt)
return
QKKks_zt:BuffDown(pVRj.CenarionWard)and not wqU76o(QKKks_zt)end)then return'Cenarion Ward Tanks'end end
if
pVRj.Regrowth:IsCastable()and not QKKks_zt:IsMoving()then
if
fuZ3z86.CastCycleAlly(pVRj.Regrowth,Hv,function(pVRj)return pVRj:HealthPercentage()<JZAU2 and not
wqU76o(pVRj)end)then return'Regrowth Members - Spam'end end
if

pVRj.Rejuvenation:IsCastable()and not NUhYw6R4 and
(
not
dijn4Ph or QKKks_zt:ManaPercentage()>=
WYdR("boss1"):HealthPercentage()+10 or
(not qkP7O5("boss1")and QKKks_zt:ManaPercentage()>60))and
(
...
QKKks_zt:BuffStack(pVRj.Rejuvenation)<2))and QKKks_zt:HealthPercentage()<zPXTTg and not wqU76o(QKKks_zt))end)then return'Rejuvenation Members'end end
if
...
(
QKKks_zt:BuffUp(pVRj.IncarnationTreeofLifeBuff)and fuZ3z86:HealthPercentage()<100)and fuZ3z86:BuffDown(pVRj.Regrowth)and not wqU76o(fuZ3z86))end)then return'Regrowth Members'end end
...
QKKks_zt:BuffDown(pVRj.Prowl)then
if Vu0cCAf(pVRj.Prowl)then return"Prowl - Stealth"end end end;local function pVRj()LB1Z()return a()end
